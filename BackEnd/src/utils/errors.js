...
const errors = {
  CLASS_FULL: (msg = "Class is full") => new AppError(msg, "CLASS_FULL", 400),
  ...
  DUPLICATE_ENROLLMENT: (msg = "You are already enrolled in this class") => new AppError(msg, "DUPLICATE_ENROLLMENT", 400),
